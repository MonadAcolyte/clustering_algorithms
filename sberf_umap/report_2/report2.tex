...
One of UMAP's hyperparameters is n components. Increasing it reduces the strenght of a single unique cluster and prioritises global grouping. Different values were tested (10, 20, 30 and 40), with 40 being the optimal one. A function to print the headers of the clusters on the best K was implemented. This allowed manually reading the results, and see if the clusters actually made any sense.
